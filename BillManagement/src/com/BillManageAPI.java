...
/**
 * Servlet implementation class BillManageAPI
 */
@WebServlet("/BillManageAPI")
public class BillManageAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = billObj.insertBill(request.getParameter("customerName"),      
